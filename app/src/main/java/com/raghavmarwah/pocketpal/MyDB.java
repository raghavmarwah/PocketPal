...
import static com.raghavmarwah.pocketpal.UserEntry.TABLE_NAME;
import static com.raghavmarwah.pocketpal.UserEntry.TABLE_NAME_2;
...
public class MyDB extends SQLiteOpenHelper{
    ...
    private static final String SQL_DELETE_ENTRIES = "DROP TABLE IF EXISTS " + TABLE_NAME + "," + TABLE_NAME_2;
